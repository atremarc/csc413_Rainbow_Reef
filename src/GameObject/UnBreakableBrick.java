...
//The UnbreakableBrick class handles the metal brick objects which cannot be destroyed
public class UnBreakableBrick extends Bricks {

    private int xPos;                   //x coordinate of the brick
    private int yPos;                   //y coordinate of the brick
    private final int RANK = 1;         //rank of the brick (used to ID the tile "type" outside this class
    ...
    public UnBreakableBrick () {
        ...
        try {
            this.image = read(new File("unbreak.png"));
    ...
    //Method used to hide a brick which has been destroyed, (never used by this class)
