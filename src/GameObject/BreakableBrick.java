...
//The BreakableBrick class handles the blue brick objects which give player points when destroyed
public class BreakableBrick extends Bricks {

    private int xPos;                   //x coordinate of the brick
    private int yPos;                   //y coordinate of the brick
    private final int RANK = 2;         //rank of the brick (used to ID the tile "type" outside this class
    ...
    public BreakableBrick () {
        ...
        try {
            this.image = read(new File("break.png"));
