...
//The TargetBrick class handles the red brick objects which must be destroyed in order to advance to the next level
public class TargetBrick extends Bricks {

    private int xPos;                   //x coordinate of the brick
    private int yPos;                   //y coordinate of the brick
    private final int RANK = 4;         //rank of the brick (used to ID the tile "type" outside this class
    ...
    public TargetBrick () {
        ...
        try {
            this.image = read(new File("target.png"));
